...
from .models import FDKObject, FDKSearchCriteria, FDKServerConfig
...
class FDKMCPServer:
    ...
    async def _handle_search_fdk_objects(self, arguments: Dict[str, Any]) -> CallToolResult:
    ...
    async def _handle_extract_object_id(self, arguments: Dict[str, Any]) -> CallToolResult:
    ...
    async def _handle_analyze_references(self, arguments: Dict[str, Any]) -> CallToolResult:
    ...
    async def _handle_get_reference_network(self, arguments: Dict[str, Any]) -> CallToolResult:
        ...
        if not start_object_id:
            return CallToolResult(
                content=[TextContent(type="text", text="Error: start_object_id is required")]
            )

        network = await self.data_provider.get_reference_network(start_object_id, max_depth)
    ...
    async def _handle_get_object_types(self, arguments: Dict[str, Any]) -> CallToolResult:
    ...
    async def _handle_get_all_objects(self, arguments: Dict[str, Any]) -> CallToolResult:
